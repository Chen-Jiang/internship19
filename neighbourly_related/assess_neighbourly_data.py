...
fieldsname = ['unique_id','first_name','last_name','address_line','suburb_name','city','postcode','eaddress','domain','phone_number','origin']
...
def assess_columns_using_dataframe_and_reg(file, fieldsname):
    ...
    # phone_records = data_framed['phone_home'].to_dict()
    # calculate_validity_of_single_column(phone_records,phone_reg,"phone_home")
    #
...
# assess_columns_using_dataframe_and_reg(input_file, fieldsname)

...
input1 = "fibre_addemail.csv"
input2 = "matrix_addemail.csv"
input3 = "neighbourly_addemail.csv"
...
def read_separate_files(input):
    ...
    with open(combined_file,'a') as combined_output:
        ...
        for ele in input:
            ...
            with open(ele,encoding = "ISO-8859-1") as input1:
...
if os.path.exists(combined_file):
    ...
    data = read_separate_files(input)

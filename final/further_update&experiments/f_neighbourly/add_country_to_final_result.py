...
def add_country_column(file):
    ...
    with open(output,'a') as o_f:
        original_fields = ['Cluster ID','confidence_score','unique_id','first_name','last_name','address_line','suburb','city','postcode','email','eaddress','domain','phone_number','origin']
        fields = ['Cluster ID','confidence_score','unique_id','first_name','last_name','address_line','suburb','city','country','postcode','email','eaddress','domain','phone_number','origin']

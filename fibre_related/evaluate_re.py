...
def compare_two_records_with_re(all_same_records,fields,field_weights,total_score):
...
def compare_more_than_two_records_with_re(all_same_records,fields,field_weights,total_score):

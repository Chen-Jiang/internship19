...
def extract_same_records(fileName):
    with open(same_file,'w', newline = '\n') as output:
        fieldnames = ['Cluster ID','confidence_score','unique_id','first_name','last_name','address_line','suburb','city','postcode','country','email','phone_number','origin']
...
def compare_same_records(all_same_records):
    ...
    fields = ['first_name','last_name','address_line','suburb','city','postcode','country','email','phone_number']
